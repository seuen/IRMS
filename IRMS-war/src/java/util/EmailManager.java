...
public class EmailManager {
    ...
    public void sendStaffPassword(String desEAdress, Staff staff, Title title, String staffAccountId, String password) {
    ...
    public void sendAttractionTicket(AttractionOrder attractionOrder,String emailAddress){
       String subject = " [Coral Island Resort] Electronical Tickets";
      String text = "Dear Customer,"+"\n\n";
      text+= "Tanks for placing an order with us! Your E-ticket information is as follows:\n";
      text += "****************************************************************************\n";
      text+="Order ID: "+attractionOrder.getId();
      text+="Total Amount: "+attractionOrder.getTotalPrice();
      text += "\n--------------------------------------------------------------------------\n";
      text+="Standalone tickets purchased: \n";
      Collection<AttractionTicketOrder> atos = attractionOrder.getAttractionTicketOrders();
      for(AttractionTicketOrder ato:atos){
          text+= ato.getType();
          text+="\n";
      }
      text+="\nBundle tickets purchased: \n";
      Collection<BundleOrder> bundleOrders = attractionOrder.getBundleOrders();
      for(BundleOrder bo:bundleOrders){
          text+= bo.getBunlde().getName();
          text+="\n";
      }
      text+="\nThanks very much for booking tickets ! We wish you would have a good time at CIR attractions\n";
       text += "Best regards,\n";
      text += "Coral Island Resort\n";
