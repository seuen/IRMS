...
@ManagedBean
@SessionScoped
public class ExternalHotelManagedBean implements Serializable{
    @EJB
    HotelManagementSessionBeanLocal hmsbl;
    private Hotel hotel=new Hotel();
    private String hotelId;

    public ExternalHotelManagedBean() {
    }
    ...
    public void navigateHotelInfo(ActionEvent event) throws IOException
    {
        ...
        if(getHotelId().contains("Hotel")){
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("customerhotelInfo.xhtml");
        }
        else{
