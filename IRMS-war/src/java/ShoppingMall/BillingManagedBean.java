...
public class BillingManagedBean implements Serializable {
    ...
    public List<TenantBill> getReportingBills() {
            ...
            this.setReportingBills(bmsb.getRecentMonthBills(Calendar.getInstance().getTime()));
    ...
    public void navigateBillInfo(ActionEvent event) throws IOException {
        ...
        if (!billid.toString().isEmpty()) {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("viewBill.xhtml");
        } else {
    ...
    public void removeInTable(ActionEvent event) throws IOException {
        try {
            ...
            if (msg.compareTo("Delete bill successfully!") != 0) {
                ...
                this.resetAll();
                FacesContext.getCurrentInstance().getExternalContext().redirect("viewAllUnpaidBills.xhtml");
            }
        } catch (Exception ex) {
    ...
    public void resetAll() {
        this.setReportingBills(bmsb.getRecentMonthBills(Calendar.getInstance().getTime()));
        this.setUnpaidBills(bmsb.getAllUnpaidBills());
        this.setAllBills(bmsb.getAllBills());
        this.setAllreceipts(bmsb.getAllReceipts());
    }
    ...
    public List<TenantBill> getBadDebtBills() {
        if (badDebtBills.isEmpty()) {
            this.setBadDebtBills(bmsb.getBadDebtBills());
        }
        return badDebtBills;
    }
