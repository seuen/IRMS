 ...
 * @author Cindylulu
 */
@ManagedBean(name = "ChargesManagedBean")
@SessionScoped
public class ChargesManagedBean {
    ...
    public ChargesManagedBean() {
        descriptionLength = "Current description length is less than 4.";
    }
...
//            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("shopId", getShopId());
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("rentalReports.xhtml");
        } else {
...
//            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("shopId", getShopId());
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("viewHistoryReports.xhtml");
        } else {
            System.out.println("ContractID does not get correctly");
        }
    }
...
//            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("shopId", getShopId());
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("viewHistoryReport.xhtml");
        } else {
            System.out.println("ContractID does not get correctly");
        }
    }
...
//    }
    ...
    public List<AdhocEvent> getAllAdhoc() {
        allAdhoc = cmsb.getAllAdhocEvents();
        return allAdhoc;
    }
