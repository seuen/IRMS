...
@ManagedBean
@SessionScoped
public class ExReservationManagedBean implements Serializable{

    public ExReservationManagedBean() {
    }
    ...
    public List<RoomType> listAllRoomTypes(){
        roomTypes = rmsbl.getAllRoomTypes(hotelId);
        return roomTypes;
    }
    ...
    public void navigateHotelInfo(ActionEvent event) throws IOException
    {
        ...
        if(getHotelId().contains("Hotel")){
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("ExSearchHotelRoom.xhtml");
        }
        else{
...
//            }
                ...
                for (RoomType currentRoomType : roomTypes) {
                    ...
                    if (minimumCnum >= roomQuantity) {
                        ...
                        if(rmsbl.isPeak(dateFrom)){
                            currentRoomType.setPrice_l(currentRoomType.getPrice_h());
                        }
                    }
                }
                ...
                System.out.println("dateFrom "+rtreservation.getDateFrom());
                System.out.println("dateTo "+rtreservation.getDateTo());
                System.out.println("duration "+rtreservation.getDuration());
                
                System.out.println(roomType);
                System.out.println(rtreservation.getDateFrom());
                
                
                dateFrom = null;
                dateTo = null;
                guestNum = 1;
                ec.redirect("ExSelectHotelRoom.xhtml");
    ...
    public void addReservation2() throws NoSuchAlgorithmException, IOException {
        ...
        if (roomType != null && roomQuantity != 0) {
            ...
            if (temp == 1) {
                ...
                System.out.println("room type is "+rtreservation.getRoomtype());
                System.out.println("quantity  is "+rtreservation.getRoomQuantity());
