...
@ManagedBean
@RequestScoped
public class PhotoUploadManagedBean {
    ...
    /**
     * Creates a new instance of PhotoUploadManagedBean
     */
    public PhotoUploadManagedBean() {
    }

    public void handleImageUpload(FileUploadEvent event)
            throws IOException {
        System.err.println("upload test");
        System.err.println(event);
        System.err.println("evet: " + event.getFile().getFileName());
        ...
        File result = new File("//Users//zsy//GlassFish_Server//glassfish//domains//domain1//docroot//images//CRM//customerPhoto//" + memberId + "." + fileNameParts[1]);
        mamsbl.EditProfilePhoto(memberId,fileNameParts[1]);
