 ...
 */
@Entity
public class DetailShoppingOrder implements Serializable {
    ...
    public DetailShoppingOrder(){
        
    }
    
    public DetailShoppingOrder(ShopItem shoppingItem, int quantity) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetailShoppingOrder)) {
            return false;
        }
        DetailShoppingOrder other = (DetailShoppingOrder) object;
