 ...
 */
@Stateless
public class ReservationManagementSessionBean implements ReservationManagementSessionBeanLocal {
...
//    private List<Integer> quotas;
    ...
    public ReservationManagementSessionBean() {
    }
    ...
    public List<RTReservation> getAllReservation() {
        Query query = em.createQuery("SELECT r FROM RTReservation r");
        setReservations((List<RTReservation>) query.getResultList());
...
//            RoomType rt=em.find(RoomType.class, rtreservation.getRoomtype().getRoomtypeId());
            ...
            System.out.println("id of reservation " + rtreservation.getReservationNum());
    ...
    public boolean deleteReservation(RTReservation reservation) {
        ...
        System.err.println("r1 is listed");
        for (RTReservation r : r1) {
            System.out.println(r);
        }
        System.err.println("r2 is listed");
        for (RTReservation r : r1) {
            System.out.println(r);
        }
        ...
        if (em.find(RTReservation.class, reservation.getReservationNum()) != null) {
            ...
            System.err.println("r1 are listed");
            for (RTReservation r : r1) {
                System.out.println(r);
            }
            System.err.println("r2 are listed");
            for (RTReservation r : r1) {
                System.out.println(r);
            }
