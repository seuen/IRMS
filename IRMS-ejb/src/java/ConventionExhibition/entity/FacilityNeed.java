 ...
 */
@Entity
public class FacilityNeed implements Serializable {
    @Id
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FacilityNeed)) {
            return false;
        }
        FacilityNeed other = (FacilityNeed) object;
    ...
    public String toString() {
        return "ConventionExhibition.entity.FacilityNeed[ id=" + getId() + " ]";
    }
